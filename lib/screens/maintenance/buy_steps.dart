...
class BuySteps extends StatefulWidget {
  final vinnumber;
  final type;
  BuySteps({Key? key, required this.vinnumber, this.type}) : super(key: key);
                        ...
                        child: TextButton(
                          onPressed: () {
                            if (_formKey.currentState!.validate()) {
                              ...
                              // Provider.of<LocationProvider>(context, listen: false).locationValue = _location;

                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => OrderConfirmationMaint(
